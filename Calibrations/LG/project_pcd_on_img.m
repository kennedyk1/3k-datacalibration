...
CameraLidarCalibration = 'LIDAR_to_RGB_CROP.mat';
FileCameraParams = 'RGB_CROP_640x512.json';

% Caminho para os arquivos de PointCloud e imagens
input_image = 'rgb_und_crop'; % Substitua pelo caminho correto
input_pcd = 'pcd'; % Substitua pelo caminho correto
